...
#for task in matbench_mp_is_metal; do
for task in matbench_dielectric matbench_jdft2d matbench_log_gvrh matbench_log_kvrh matbench_mp_e_form matbench_mp_gap matbench_perovskites matbench_phonons matbench_mp_is_metal; do
