...
def main():
    ...
    parser.add_argument("--datasetname", help="dataset name", default="abc3")
    parser.add_argument("--modelname", help="model name", default="abc3")
    ...
    # NOTE: transforms/filters will NOT be re-run unless the abc3/processed/ directory is removed.
    dataset = torch.load("examples/abc3/abc3_dataset.pt", weights_only=False)
